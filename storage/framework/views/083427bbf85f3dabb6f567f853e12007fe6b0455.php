                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" <?php if(app()->getLocale() == $locale): ?> style="text-decoration: underline" <?php endif; ?> href="<?php echo e(route(\Illuminate\Support\Facades\Route::currentRouteName(), $locale)); ?>"><?php echo e(strtoupper($locale)); ?></a>
                        </li>
