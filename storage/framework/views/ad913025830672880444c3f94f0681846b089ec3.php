                    ...
                    <div class="row">
                        <div class="col-md-4">
                          <div class="card-counter primary">
                            ...
                            <span class="count-numbers"><?php echo e($allcompanies); ?></span>
                            <span class="count-name">Companies</span>
                          </div>
                           <a href="<?php echo e(URL::to('companies')); ?>">
                       ...
                       <div class="col-md-4"></div>
                        <div class="col-md-4">
                          <div class="card-counter danger">
                            ...
                            <span class="count-numbers"><?php echo e($allemployees); ?></span>
                            <span class="count-name">Employees</span>
                         </div>
                          <a href="<?php echo e(URL::to('employees')); ?>">
